        ...
        <section className="grid md:grid-cols-12 gap-12 items-center">
          <div className="md:col-span-6 space-y-6">
            ...
            <h1 className="text-5xl md:text-6xl font-black tracking-tighter text-zinc-950 leading-[1.1]">
              Clarity for your mind, <br /> <span className="text-transparent bg-clip-text bg-linear-to-r from-[#4facfe] to-[#00f2fe]">step by step.</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <Link onClick={scrollTop} to="/login" className="flex items-center justify-center gap-2 px-10 py-4 text-lg font-bold text-white bg-linear-to-r from-[#4facfe] to-[#00f2fe] rounded-2xl shadow-xl shadow-cyan-500/20 hover:scale-105 transition-transform">
                <PlusCircle size={22} /> Start Journaling
              </Link>
              <Link onClick={scrollTop} to="/about" className="flex items-center justify-center gap-2 px-8 py-4 text-lg font-bold text-zinc-800 bg-white rounded-2xl border border-zinc-200 hover:bg-zinc-50 transition-all">
                Learn More
              </Link>
            </div>
          </div>
        ...
        <section className="bg-white p-8 md:p-12 rounded-[3rem] shadow-xl shadow-zinc-200/40 border border-zinc-100">
          <div className="grid md:grid-cols-4 gap-8 items-center">
            ...
            <div className="md:col-span-3 flex flex-wrap gap-4">
              ...
              <Link onClick={scrollTop} to="/login" className="flex items-center gap-2.5 px-8 py-4 rounded-2xl bg-zinc-900 text-white hover:bg-zinc-800 ml-auto shadow-lg shadow-zinc-900/20">
                <PenTool size={20} />
...
function FeatureCard({ icon, title, desc, color }) {
  ...
  return (
    <div className="bg-white p-8 rounded-4xl shadow-lg border border-zinc-100 space-y-6">
