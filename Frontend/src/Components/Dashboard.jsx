...
import { 
  Plus, Calendar, TrendingUp, Sun, Moon, 
  MoreHorizontal,Heart, ChevronRight, BookOpen, Clock 
} from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#F8FAFC] flex flex-col md:flex-row">
      ...
      <aside className="w-full md:w-64 bg-white border-r border-slate-200 p-6 flex flex-col gap-8">
        <div className="flex items-center gap-3">
          <img src={Logo} alt="Zenith" className="size-8" />
          <span className="font-black text-xl tracking-tight">ZENITH</span>
        </div>
        ...
        <div className="mt-auto bg-linear-to-br from-indigo-500 to-cyan-400 p-4 rounded-2xl text-white">
          <p className="text-xs font-bold uppercase opacity-80">Pro Plan</p>
          <p className="text-sm font-medium mt-1">Unlock AI insights</p>
          <button className="w-full mt-3 py-2 bg-white/20 hover:bg-white/30 rounded-lg text-xs font-bold transition-colors">
            Upgrade
          </button>
        </div>
      </aside>
      ...
      <main className="flex-1 p-4 md:p-8 space-y-8 overflow-y-auto">
        ...
        <header className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            <h1 className="text-3xl font-black text-slate-900">Good morning, Alex.</h1>
